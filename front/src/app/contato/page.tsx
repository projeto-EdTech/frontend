...
export default function ContatoPage() {
  ...
  const socialInView = useInView(socialSectionRef, {
    once: true,
    margin: "-50px",
  });
  ...
  const isFormValid =
    formData.nome && formData.email && formData.assunto && formData.mensagem;
        ...
        <div className="container mx-auto px-6 md:px-8 py-12 md:py-20 relative z-10 max-w-7xl">
          ...
          >
            ...
            >
              ...
              pronta para responder suas perguntas e oferecer o melhor suporte
              possível.
            </motion.p>
          </motion.div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <h2
                    className={`text-2xl font-semibold tracking-tight ${theme === "dark" ? "text-white" : "text-[#1d1d1f]"}`}
                  >
                    Fale Conosco
                  </h2>
                </motion.div>
                ...
                <motion.div className="space-y-6" variants={staggerContainer}>
                  ...
                  <motion.div className="group" variants={staggerItem}>
                    <div
                      className={`flex items-start gap-4 p-4 rounded-[12px] transition-all duration-300 ${
                        theme === "dark"
                          ? "hover:bg-white/5"
                          : "hover:bg-black/5"
                      }`}
                    >
                      ...
                      <div>
                        <h3
                          className={`font-semibold mb-1 text-lg tracking-tight ${theme === "dark" ? "text-white" : "text-[#1d1d1f]"}`}
                        >
                          Email
                        </h3>
                        <p
                        ...
                        <p
                          className={`text-sm mt-2 flex items-center gap-1 ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}
                        >
                  ...
                  <motion.div className="group" variants={staggerItem}>
                    ...
                    >
                      ...
                      <div>
                        <h3
                          className={`font-semibold mb-2 text-lg tracking-tight ${theme === "dark" ? "text-white" : "text-[#1d1d1f]"}`}
                        >
          ...
          >
            ...
            >
              <h2
                className={`text-3xl md:text-4xl font-semibold tracking-tight mb-4 ${theme === "dark" ? "text-white" : "text-[#1d1d1f]"}`}
              >
            ...
            >
              ...
              >
                ...
                <h3
                  className={`font-semibold tracking-tight mb-3 text-xl ${theme === "dark" ? "text-white" : "text-[#1d1d1f]"}`}
                >
                  Instagram
                </h3>
                <p
