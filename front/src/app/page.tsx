                    ...
                    <div className="relative z-10 py-12 px-6">
                      ...
                      >
                        ...
                        <span className="font-semibold text-blue-600">
                          provas reais dos vestibulares
                        </span>{" "}
                        com cronômetro, veja seu
                        <span className="font-semibold text-purple-600">
                          {" "}
                          desempenho por matéria
                        </span>{" "}
                        e descubra se você bate a nota de corte do curso que quer
                      </p>
                        ...
                        <div className="relative max-w-4xl mx-auto">
                          <div className="force-themed-card rounded-2xl shadow-2xl p-3 md:p-4 transform hover:scale-105 transition-all duration-300">
                            ...
                            <div className="rounded-lg p-3 md:p-4">
                              ...
                              {/* Matéria com menor aproveitamento */}
                              <div className="mt-3 p-2 bg-blue-100 rounded-lg border-l-4 border-blue-500">
                                ...
                                <span className="text-xs text-gray-800">
                                  Química — a matéria com mais erros nos seus
                                  últimos simulados
                                </span>
                              </div>
                            </div>
                  ...
                  <div className="text-left space-y-8 animate-fade-in-up">
                    ...
                    <p className="text-lg md:text-xl text-gray-600 max-w-lg leading-relaxed font-light font-sans">
                      {isAuthenticated
                        ...
                        : "A plataforma completa para o seu estudo. Resolva simulados, acompanhe seu progresso e conquiste sua aprovação."}
                    </p>
                      ...
                      <>
                        ...
                        >
                          ...
                          <div className="relative z-10 flex flex-col items-center text-center h-full">
                            ...
                            <p className="text-gray-600 font-medium leading-relaxed text-sm">
                              Simule se você passaria ou não nos vestibulares,
                              sem precisar "pagar para ver".
                            </p>
                          </div>
                        </motion.div>
                    ...
                    <div className="relative z-10">
                      ...
                      <ul className="space-y-2 md:space-y-3">
                        {[
                          ...
                          "Gabarito comentado e desempenho por matéria",
                        ].map((item, index) => (
                          <li
                            key={index}
                            className="flex items-start gap-2 themed-text text-gray-600 text-sm md:text-base"
            ...
            >
              ...
              <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-12 relative">
                  <h2
                    className={`text-[40px] font-bold mb-3 leading-tight tracking-tight ${isDark ? "text-white" : "text-[#1d1d1f]"}`}
                  >
                    Escolha Seu Plano
                  </h2>
                  <p
                    className={`text-[18px] font-normal leading-relaxed max-w-[600px] mx-auto ${isDark ? "text-gray-400" : "text-black/60"}`}
                  >
                ...
                >
                  <div
                    className={`flex items-center gap-2 ${isDark ? "text-gray-500" : "text-black/40"}`}
                  >
