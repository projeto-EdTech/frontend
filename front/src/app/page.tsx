...
const HERO_FEATURES = [
  {
    id: 0,
    name: "Simulado Personalizado",
    description:
      "Um simulado adaptativo que se ajusta ao seu nível de conhecimento.",
  },
  {
    id: 1,
    name: "Biblioteca de Provas",
    description: "Acesso a uma vasta biblioteca de provas anteriores.",
  },
  {
    id: 2,
    name: "Cronograma de Estudos",
    description: "Um cronograma de estudos personalizado para você.",
  },
  {
    id: 3,
    name: "Consulta de Nota de Corte",
    description: "Consulte a nota de corte das universidades.",
  },
  {
    id: 4,
    name: "Questões com IA",
    description: "Questões geradas por IA para praticar.",
  },
  {
    id: 5,
    name: "Estatísticas Avançadas",
    description: "Estatísticas detalhadas sobre seu desempenho.",
  },
];
...
export default function Home() {
  ...
  const [loginRedirectUrl, setLoginRedirectUrl] = useState<string | undefined>(
    "/paidPlan",
  );
      ...
      <div className="themed-main-container min-h-screen force-themed-bg flex flex-col">
        ...
        <main className="flex-1" id="inicio">
                            ...
                            <div className="rounded-lg p-3 md:p-4">
                              ...
                              <div className="mt-3 p-2 bg-blue-100 rounded-lg border-l-4 border-blue-500">
                                ...
                                <span className="text-xs text-gray-800">
                                  Foque em Química - Para melhorar seu
                  ...
                  "
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 relative">
                      <a
                        href="/profile"
                        onClick={(e) =>
                          handleLandingPageClick(e, "/profile", false)
                        }
                        className="
                        ...
                        renderItem={(feature) => {
                          ...
                          const renderContent = () => {
                            switch (feature.id) {
                              ...
                              case 1:
                                return <BancoProvasMockup {...props} />;
                              case 2:
                                return <CronogramaMockup {...props} />;
                              case 3:
                                return <NotaDeCorteMockup {...props} />;
                              case 4:
                                return <QuestoesIAMockup {...props} />;
                              case 5:
                                return <EstatisticasMockup {...props} />;
                              default:
                                return null;
                            }
                          };
                          ...
                          return (
                            <div
                              className={`w-full min-w-[750px] max-w-[500px] rounded-3xl overflow-hidden shadow-2xl flex flex-col transition-colors duration-300 ${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border`}
                            >
                              ...
                              <div
                                className={`flex-1 p-6 relative ${isDark ? "bg-gray-900" : "bg-slate-50"}`}
                              >
                                {renderContent()}
                              </div>
                            </div>
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="prose prose-lg text-gray-600 leading-relaxed font-sans">
                        {isAuthenticated ? (
                          <>
                            <p>
                              Faça seu upgrade de plano e aproveite ao máximo
                              todas as ferramentas disponíveis. Explore
                              simulados inéditos, analise seu desempenho
                              detalhado e monitore seus pontos de melhoria,
                              elabore cronograma de estudos personalizados e
                              muito mais.
                            </p>
                          </>
                        ) : (
                          <>
                            <p>
                              Tenha acesso a mais de 150 mil questões para se
                              preparar para o Enem e vestibulares de todo o
                              Brasil.
                            </p>
                            <p>
                              Monte listas de exercícios personalizadas com os
                              conteúdos de cada matéria, resolva provas de
                              exames anteriores e monitore o seu desempenho com
                              relatórios de erros e acertos.
                            </p>
                          </>
                        )}
                      </div>
                      ...
                      <>
                        ...
                        >
                          ...
                          <div className="relative z-10 flex flex-col items-center text-center h-full">
                            ...
                            <p className="text-gray-600 font-medium leading-relaxed text-sm">
                              Simulados sem restrições. Pratique o quanto
                        ...
                        >
                          ...
                          <div className="relative z-10 flex flex-col items-center text-center h-full">
                            ...
                            <p className="text-gray-600 font-medium leading-relaxed text-sm">
                              Cronograma de estudos personalizado e otimizado
                      ...
                      <>
                        ...
                        >
                          ...
                          <div className="relative z-10 flex flex-col items-center text-center h-full">
                            ...
                            <p className="text-gray-600 font-medium leading-relaxed text-sm">
                              Acesso completo a questões do ENEM e dos
                        ...
                        >
                          ...
                          <div className="relative z-10 flex flex-col items-center text-center h-full">
                            ...
                            <p className="text-gray-600 font-medium leading-relaxed text-sm">
                              Simule exames reais com provas anteriores
                              completas para você treinar.
                            </p>
                          </div>
                        </motion.div>
              ...
              >
                <div className="container mx-auto px-4 md:px-6">
                  <div className="text-center mb-16">
                    ...
                    >
                      {isAuthenticated
                        ? "Veja os Recursos do Simula PRO"
                        : "Por dentro do Vestibuline"}
                    </h2>
                  </div>
              ...
              <div className="force-themed-card bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 rounded-3xl p-8 md:p-12 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-8 animate-fade-in-up relative overflow-hidden">
                ...
                <div className="text-center lg:text-left flex-1 relative z-10">
                  ...
                  <p className="text-white text-lg md:text-xl max-w-2xl mb-8 leading-relaxed">
                    Compare seu desempenho com estudantes de todo o país, suba
                    no placar e
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-16">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Devolvemos seu dinheiro, cancele quando quiser",
          ...
          {!hasPaidPlan && (
            <div
              id="planos"
              className={`py-24 relative overflow-hidden transition-colors duration-300 ${isDark ? "bg-gray-900" : ""}`}
              style={!isDark ? { background: "linear-gradient(180deg, #FAFAFA 0%, #F5F5F7 100%)" } : undefined}
            >
              <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-12 relative">
                  ...
                  <p className={`text-[18px] font-normal leading-relaxed max-w-[600px] mx-auto ${isDark ? "text-gray-300" : "text-black"}`}>
