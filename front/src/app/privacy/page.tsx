            ...
            <div className="text-center mb-16 md:mb-20 relative">
              ...
              >
                <div className="relative w-40 h-40 md:w-48 md:h-48 lg:w-56 lg:h-56">
                  ...
                  {/* Subtle ring */}
                  <div
                    className={`absolute inset-[-12px] border rounded-full ${
              ...
              >
                <p
                  className={`text-lg md:text-xl leading-relaxed font-normal ${
                    theme === "dark" ? "text-gray-300" : "text-[#1d1d1f]"
                  }`}
                >
                  Sua privacidade é fundamental para nós. Esta Política de
                  Privacidade explica como coletamos, usamos, protegemos e
                  compartilhamos suas informações ao utilizar o site
                  www.vestibuline.com e nossos serviços digitais.
                </p>
              </motion.div>
              ...
              <div className="space-y-10 md:space-y-14">
                ...
                >
                  <div className="flex items-start gap-5 mb-5">
                    <div
                      className={`w-10 h-10 rounded-[12px] flex items-center justify-center text-white font-semibold text-sm flex-shrink-0 shadow-md ${
                        theme === "dark"
                    ...
                    <div className="flex-1">
                      ...
                      >
                        Coletamos informações fornecidas por você ao se
                        cadastrar, preencher formulários ou interagir com nossos
                        serviços. Também coletamos dados automaticamente, como
                        endereço IP, tipo de navegador, páginas acessadas e
                    ...
                    <div className="flex-1">
                      ...
                      >
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          ></span>
                          <span>
                            Entrar em contato sobre novidades, atualizações ou
                            suporte;
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-5 mb-5">
                    ...
                    <div className="flex-1">
                      ...
                      >
                        ...
                        com terceiros, exceto quando necessário para prestação
                        dos serviços, cumprimento de obrigações legais ou
                ...
                <motion.section variants={fadeIn("up", 0.7)} className="group">
                  <div className="flex items-start gap-5 mb-5">
                    ...
                    <div className="flex-1">
                      ...
                      >
                        Utilizamos cookies para melhorar a navegação, analisar o
                        uso do site e personalizar conteúdo. Você pode gerenciar
                ...
                >
                  <div className="relative flex flex-col md:flex-row items-center justify-center gap-10 md:gap-16 px-8">
                    ...
                    <div className="text-center max-w-xl z-10">
                      <h3
                        className={`text-2xl md:text-3xl lg:text-4xl font-semibold mb-3 tracking-tight ${
                          theme === "dark" ? "text-white" : "text-[#1d1d1f]"
                        }`}
                      >
                  ...
                  <div className="flex items-start gap-5 mb-5">
                    ...
                    <div className="flex-1">
                      ...
                      >
                        ...
                        divulgação ou destruição. No entanto, nenhum sistema é
                        totalmente seguro e não podemos garantir a segurança
                        absoluta dos dados.
                      </p>
                    </div>
                  </div>
                ...
                <motion.section variants={fadeIn("up", 0.9)} className="group">
                  <div className="flex items-start gap-5 mb-5">
                    ...
                    <div className="flex-1">
                      ...
                      >
                        Você pode solicitar acesso, correção ou exclusão de seus
                        dados pessoais a qualquer momento, bem como revogar seu
                        consentimento para o uso de determinadas informações.
                      </p>
                    </div>
                  </div>
                </motion.section>
                  ...
                  <div className="flex items-start gap-5 mb-5">
                    ...
                    <div className="flex-1">
                      ...
                      >
                        ...
                        periodicamente. Notificaremos sobre mudanças
                        significativas por meio do site ou outros canais de
                        contato fornecidos por você.
                      </p>
                    </div>
                  </div>
                </motion.section>
                ...
                >
                  <div className="flex items-start gap-5 mb-5">
                    <div
                      className={`w-10 h-10 rounded-[12px] flex items-center justify-center text-2xl flex-shrink-0 shadow-md ${
                        theme === "dark"
