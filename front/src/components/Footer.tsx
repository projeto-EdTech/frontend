      ...
      <div className="container mx-auto px-6 py-16 relative">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1 space-y-6">
            <Link
              href="/"
              className="group flex items-center mb-6 hover:scale-105 transition-all duration-300 w-fit"
            >
            ...
            <p className="themed-text-secondary text-base leading-relaxed max-w-sm">
              ...
              e garantir a aprovação no vestibular! ✨
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/library"
                  className="group inline-flex items-center themed-text-secondary hover:text-blue-600 dark:hover:text-blue-400 text-sm font-medium transition-all duration-300 hover:translate-x-1"
                >
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/terms"
                  className="group inline-flex items-center themed-text-secondary hover:text-cyan-600 dark:hover:text-cyan-400 text-sm font-medium transition-all duration-300 hover:translate-x-1"
                >
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-3">
                {/* Instagram */}
                <a
                  href="https://instagram.com/vestibuline"
                  target="_blank"
                ...
                >
                  ...
                  <svg
                    ...
                    height="18"
                    fill="currentColor"
                    className="relative z-10 themed-text-secondary group-hover:text-pink-600 dark:group-hover:text-pink-400 transition-all duration-300 group-hover:rotate-12"
                    viewBox="0 0 16 16"
                  >
                ...
                >
                  ...
                  <svg
                    ...
                    height="18"
                    fill="currentColor"
                    className="relative z-10 themed-text-secondary group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-all duration-300 group-hover:-rotate-12"
                    viewBox="0 0 16 16"
                  >
                ...
                >
                  ...
                  <svg
                    ...
                    height="18"
                    fill="currentColor"
                    className="relative z-10 themed-text-secondary group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-all duration-300 group-hover:rotate-6"
                    viewBox="0 0 16 16"
                  >
                ...
                {/* TikTok */}
                <a
                  href="https://www.tiktok.com/@vestibuline"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="TikTok"
                ...
                >
                  ...
                  <svg
                    ...
                    height="18"
                    fill="currentColor"
                    className="relative z-10 themed-text-secondary group-hover:text-gray-800 dark:group-hover:text-gray-300 transition-all duration-300 group-hover:scale-110"
                    viewBox="0 0 16 16"
                  >
                ...
                {/* YouTube */}
                <a
                  href="https://www.youtube.com/@vestibuline"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                ...
                >
                  ...
                  <svg
                    ...
                    height="18"
                    fill="currentColor"
                    className="relative z-10 themed-text-secondary group-hover:text-red-600 dark:group-hover:text-red-400 transition-all duration-300 group-hover:-rotate-6"
                    viewBox="0 0 16 16"
                  >
