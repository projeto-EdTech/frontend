      ...
      >
        ...
        <div className="h-11 bg-white border-b border-gray-300 flex items-center px-5 justify-between shrink-0 select-none z-50 backdrop-blur-sm">
          <div className="flex items-center gap-2 group">
            ...
            >
              <svg
                className="w-1.5 h-1.5 text-black/60 opacity-0 group-hover:opacity-100 transition-opacity"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="4"
            ...
            <button
              onClick={onClose}
              className="w-3 h-3 rounded-full bg-[#FEBC2E] shadow-sm flex items-center justify-center cursor-pointer group-hover:shadow-none"
          ...
          <div className="text-center mb-6 md:mb-10 relative">
              ...
              <div className="relative w-28 h-28 md:w-36 md:h-36 mx-auto">
                ...
                <div className="relative w-full h-full">
                  <Image
                    ...
                    alt="Mascote Vestibuline - Demonstração"
                    fill
            ...
            <div className="max-w-3xl mx-auto bg-white/40 rounded-2xl p-4 md:p-6 border border-white/60 shadow-sm backdrop-blur-md">
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                Descubra como o{" "}
                <span className="font-bold text-blue-600">Vestibuline</span>{" "}
                pode
                <span className="font-semibold text-purple-600">
                  {" "}
                  transformar seu desempenho
                </span>{" "}
                no vestibular através de nossa
                  ...
                  <div className="flex flex-col items-center space-y-6">
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-gray-400 text-sm">
                        Prepare-se para conhecer o Vestibuline!
                      </p>
                    </div>
